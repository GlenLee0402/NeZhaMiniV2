      ...
      P = function (t) {
        function o(e, i) {
          ...
          return r.blocks = [], r.prizes = [], r.buttons = [], r.defaultConfig = {}, r._defaultConfig = {
            ...
            wordWrap: !0,
            lengthLimit: "90%"
          }, r.Radius = 0, r.prizeRadius = 0, r.prizeDeg = 0, r.prizeRadian = 0, r.rotateDeg = 0, r.maxBtnRadius = 0, r.startTime = 0, r.endTime = 0, r.stopDeg = 0, r.endDeg = 0, r.FPS = 16.6, r.blockImgs = [
            []
          ], r.prizeImgs = [
            []
          ], r.btnImgs = [
            []
          ], e.ob && (r.initData(i), r.initWatch()), r.initComputed(), null === (n = e.beforeCreate) || void 0 === n || n.call(r), r.init({
      ...
      D = function (t) {
        function h(e, i) {
          ...
          r.rows = 3, r.cols = 3, r.blocks = [], r.prizes = [], r.buttons = [], r.defaultConfig = {}, r._defaultConfig = {
            ...
            lineHeight: "",
            fontColor: ""
          }, r.cellWidth = 0, r.cellHeight = 0, r.startTime = 0, r.endTime = 0, r.currIndex = 0, r.stopIndex = 0, r.endIndex = 0, r.demo = !1, r.timer = 0, r.FPS = 16.6, r.prizeFlag = -1, r.cells = [], r.blockImgs = [
            []
          ], r.btnImgs = [
            []
          ], r.prizeImgs = [], e.ob && (r.initData(i), r.initWatch()), r.initComputed(), null === (n = e.beforeCreate) || void 0 === n || n.call(r);
